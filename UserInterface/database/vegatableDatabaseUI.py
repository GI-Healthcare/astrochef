...
class VegetableDatabaseWindow(ctk.CTkFrame):
    def __init__(self, master):
        ...
        self.carbs = ctk.CTkLabel(self, text="Vegetable", font=labelFont)
        ...
        self.inventoryName = ctk.CTkLabel(self, text="Vegetable Name", font=labelFont)
        ...
        self.inventoryLink = ctk.CTkLabel(self, text="Vegetable Link", font=labelFont)
        ...
        column_width = 210
        self.my_tree['columns'] = ("ID", "Vegetable Name", "Vegetable Link")
        self.my_tree.column("#0", width=0, stretch=tk.NO)
        self.my_tree.column("ID", anchor=tk.W, width=20)
        self.my_tree.column("Vegetable Name", anchor=tk.W, width=column_width)
        self.my_tree.column("Vegetable Link", anchor=tk.W, width=column_width)

        self.my_tree.heading("ID", text="ID", anchor=tk.W)
        self.my_tree.heading("Vegetable Name", text="Vegetable Name", anchor=tk.W)
        self.my_tree.heading("Vegetable Link", text="Vegetable Link", anchor=tk.W)
    ...
    def update(self, id, name, link, idName):
        ...
        cursor.execute("UPDATE "+table+" SET inventoryId = '" + str(id) + "', inventoryName = '" + str(name) + "', inventoryLink = '" + str(link) + "' WHERE foodId='"+str(idName)+"'")
        conn.commit()
