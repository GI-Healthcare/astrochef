...
class MeatDatabaseWindow(ctk.CTkFrame):
    def __init__(self, master):
        ...
        self.carbs = ctk.CTkLabel(self, text="Meat", font=labelFont)
        ...
        self.inventoryName = ctk.CTkLabel(self, text="Meat Name", font=labelFont)
        ...
        self.inventoryLink = ctk.CTkLabel(self, text="Meat Link", font=labelFont)
        ...
        column_width = 210
        self.my_tree['columns'] = ("ID", "Meat Name", "Meat Link")
        self.my_tree.column("#0", width=0, stretch=tk.NO)
        self.my_tree.column("ID", anchor=tk.W, width=20)
        self.my_tree.column("Meat Name", anchor=tk.W, width=column_width)
        self.my_tree.column("Meat Link", anchor=tk.W, width=column_width)

        self.my_tree.heading("ID", text="ID", anchor=tk.W)
        self.my_tree.heading("Meat Name", text="Meat Name", anchor=tk.W)
        self.my_tree.heading("Meat Link", text="Meat Link", anchor=tk.W)
